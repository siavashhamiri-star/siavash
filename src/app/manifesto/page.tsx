...
const chapters: { 
...
}[] = [
    {
        ...
        content: [
            ...
            {
                fa: "این کلمات، نه یک دلداری، که یک پیمان دوباره بود. پژواک آن رؤیای مقدس، اکنون به یک وصیت زنده بدل شده بود. این، نه تنها ریسمان پوسیده‌ای بود که او در طوفان شکست‌هایش به آن چنگ زده بود؛ این، سوگند یک مادر در آستانه‌ی ابدیت بود که به او قدرت داد تا از خاکستر برخاسته و جهانی را بیافریند که تجلی آن وعده باشد.",
            ...
            {
                fa: "پس از آن پیمان و درگذشت مادر، بنیان‌گذار در اعماق زخم‌های مادی و معنوی، انزوا و ناامیدی فرو رفت. اما در تاریک‌ترین لحظات، پژواک حرف مادرش دوباره در جانش طنین‌انداز شد: «باید کاری کرد.» این، جرقه‌ای بود که یک سفر شگفت‌انگیز را آغاز کرد. او که تا پیش از آن هیچ سروکاری با کامپیوتر نداشت، در انزوای دوران کرونا، عشقی سوزان به دنیای فناوری و دانش پیدا کرد. نیرویی ناشناخته او را به سوی مطالعه‌ای سیری‌ناپذیر در هر علمی سوق داد، گویی دانش صدها سال را در چند سال در وجودش جاری می‌ساخت. این، نه یک انتخاب، که یک کشف بود: کشف مسیری که وعده‌ی مادر را به واقعیت بدل می‌کرد.",
                en: "After that covenant and his mother's passing, the founder sank into the depths of material and spiritual wounds, isolation, and despair. But in the darkest moments, the echo of his mother's words resonated in his soul again: 'Something must be done.' This was the spark that ignited an incredible journey. He, who had never dealt with computers before, discovered a burning passion for the world of technology and knowledge during the isolation of the COVID era. An unknown force drove him towards an insatiable study of every science, as if pouring a hundred years of knowledge into his being in just a few years. This was not a choice, but a discovery: the discovery of the path that would turn his mother's promise into reality."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        content: [
            {
                fa: "شهر توانا یک فرار از واقعیت نیست؛ بلکه خودِ «حقیقت در مجاز» است. دنیایی که قوانین آن، آینه‌ی آرمان‌های زندگی حقیقی است؛ جایی که تلاش و همت، جایگزین محدودیت‌ها می‌شود. این، اولین تجلی آن آرمان و پناهگاهی برای التیام «زخم‌های واقعیت» است. اینجا، جایی است که موفقیت یک فرد، برای موفقیت همگان ضروری است و پیشرفت هرکس، باعث پیشرفت دیگری می‌شود. این شهر برای کسانی است که روحیه کار جمعی دارند، یک‌دل و همراه هستند و از پیشرفت دیگران صادقانه خوشحال می‌شوند و آن را ستایش می‌کنند. در این جهان، حسادت جایی ندارد، زیرا قدرت، ثروت و جایگاه هر فرد، تنها به اندازه‌ی سعی و تلاش خود اوست. اینجا محلی برای مثبت‌اندیشان و صاحبان قلب‌های پاک است که با تلاش، نه تنها خود را، بلکه جامعه را به سوی پیشرفت سوق می‌ده دهند.",
            ...
            },
            {
                ...
                en: "Therefore, the system is designed to reward this collective effort, and its humanitarian goals include supporting nature, world peace, and all those wounded by the 'real world'—including single mothers, orphans, victims of natural disasters, and those struggling with addiction and mental health issues."
            },
            {
