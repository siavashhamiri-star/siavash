        ...
        content: [
            {
                ...
                en: "'Tavana City' is the first manifestation of this ideal. A sanctuary to heal the 'wounds of reality'. Here is a place where one person's success is essential for everyone's success, and everyone's progress leads to another's progress. This city is for those with a spirit of teamwork, who are united and supportive, and who are genuinely happy for and praise the progress of others. In this world, there is no place for jealousy, because each person's power, wealth, and status are only proportional to their own effort and endeavor. This is a place for positive thinkers and owners of pure hearts who, through effort, drive not only themselves but the entire community towards advancement. The system is designed to reward this collective effort, and its humanitarian goals include: supporting nature, world peace, single mothers, and orphans."
            },
            {
                fa: "جامعه «شهر توانا» از طریق انجمن‌ها (Guilds) و بازارهای پویای خود شکوفا می‌شود. اینجا خانه‌ی متخصصان و کارآفرینان در هر حوزه‌ای خواهد بود: از انجمن‌های علمی، فرهنگی و هنری گرفته تا بازارهای تخصصی مانند صرافی‌های ارز دیجیتال، آژانس‌های املاک مجازی و تأمین‌کنندگان تجهیزات تولید محتوا. ما از خلاقیت و نوآوری حمایت می‌کنیم، از حقوق حیوانات دفاع می‌کنیم و هر ایده‌ای را که به پیشرفت جامعه و صنعت انفورماتیک کمک کند، ارج می‌نهیم. شهر توانا، بستری برای هر استعداد و هر تخصصی است تا به توانایی و شکوفایی برسد.",
                en: "The society of 'Tavana City' will flourish through its dynamic guilds and marketplaces. It will be home to specialists and entrepreneurs in every field: from scientific, cultural, and artistic guilds to specialized markets such as digital currency exchanges, virtual real estate agencies, and providers of content creation equipment. We support creativity and innovation, defend animal rights, and cherish any idea that contributes to the advancement of society and the informatics industry. Tavana City is a platform for every talent and every specialty to achieve capability and prosperity."
            },
            {
                fa: "سرمایه‌ی واقعی ما، انسان‌ها هستند؛ 'معجزه‌هایی که معجزه می‌آفرینند'. این شایسته‌سالاری به مدلی از خودگردانی مطلق گسترش می‌یابد. مدیران «شهر توانا»، نخبگان و صدرنشینان برنامه‌های مختلف اکوسیستم (بازوهای اجرایی) خواهند بود؛ کسانی که با کوشش و درخشش در یک اپلیکیشن، به بالاترین جایگاه‌ها در آن دست می‌یابند و سپس، به تالار رهبری استراتژیک شهر توانا راه پیدا می‌کنند تا در تصمیم‌گیری‌های کلان مشارکت داشته باشند. نقشه راه ما، معرفی یک بال قدرتمند بازی و سپس یک ارز دیجیتال بومی است تا یک اقتصاد دیجیتال خودپایدار ایجاد شود که حاکمیت آن در نهایت به جامعه واگذار خواهد شد.",
                en: "Our real capital is people; 'miracles who create miracles'. This meritocracy extends to a model of absolute self-governance. The leaders of 'Tavana City' will be the elites and top performers from the ecosystem's various programs (the executive arms); those who, through effort and brilliance within an application, achieve its highest positions and then find their way to the strategic leadership hall of Tavana City to participate in macro-level decision-making. Our roadmap is to introduce a powerful gaming wing and then a native cryptocurrency to create a self-sustaining digital economy whose governance will ultimately be handed over to the community."
            }
        ]
    },
    {
        ...
        content: [
            {
                ...
                en: "Your power is not in controlling borders, but in removing them. Your armies fight over resources that are but a speck against the vastness of the cosmos. You fight over soil, while we have our eyes on the stars. We have brought a new literature for global diplomacy; a literature that does not ask politicians to fight each other, but asks them to build together."
            },
            {
