        ...
        <div className="flex items-center gap-4">
          <Link href="/" className="flex items-center space-x-2">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-primary font-medium tracking-widest uppercase">Global Bazaar (Farsh Bazaar)</span>
            </div>
          </Link>
                ...
                <div className="flex flex-col h-full p-6">
                    <Link href="/" className="flex items-center space-x-2 mb-8 border-b pb-4">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-[10px] text-primary uppercase">Farsh Bazaar</span>
                        </div>
                    </Link>
